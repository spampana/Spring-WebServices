...
public class DemoRestClient {
    ...
    public BookVO getBook(String bookName) throws Exception {
        ...
        String output = null;
        try{
            String url = "http://localhost:8080/Spring-Maven-REST-CXF-Example/bookservice/getbook/";
    ...
    public void addBook(String bookName, String author) throws Exception {
        ...
        String output = null;
        try{
            String url = "http://localhost:8080/Spring-Maven-REST-CXF-Example/bookservice/addbook";
            HttpClient client = new HttpClient();
            PostMethod mPost = new PostMethod(url);
